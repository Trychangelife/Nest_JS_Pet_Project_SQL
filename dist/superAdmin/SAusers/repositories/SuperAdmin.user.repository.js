...
exports.SuperAdminUsersRepository = void 0;
...
let SuperAdminUsersRepository = class SuperAdminUsersRepository {
    constructor(usersModel, registrationDataModel, authDataModel, codeConfirmModel, emailSendModel, refreshTokenModel, recoveryPasswordModel, newPasswordModel, blogModel) {
    ...
    async allUsers(skip, limit, sortDirection, sortingParam, page, searchLoginTerm, searchEmailTerm, banStatus) {
        const query = {};
        if (searchEmailTerm) {
    ...
    async banUser(id, reason, isBanned) {
        if (isBanned == true) {
    ...
    async checkBanStatus(userId, blogId) {
        if (userId !== null) {
...
exports.SuperAdminUsersRepository = SuperAdminUsersRepository;
exports.SuperAdminUsersRepository = SuperAdminUsersRepository = __decorate([
    ...
    __param(8, (0, mongoose_2.InjectModel)('Blogs')),
...
//# sourceMappingURL=SuperAdmin.user.repository.js.map